...
<template>
    <UContainer>
        <UPageHero title="Professional Journey"
            description="A timeline of my career path, key roles, and significant milestones." align="center" />
                ...
                <div v-for="(item, index) in experience" :key="index"
                    ...
                    <div class="md:w-1/2 flex items-center"
                        ...
                        <div class="ml-12 md:ml-0">
                            ...
                            <span
                                class="text-gray-900 dark:text-white font-bold text-xl block mt-1">{{ item.company }}</span>
                        ...
                        <div
                            ...
                            <div class="space-y-6">
                                <div v-for="(role, roleIndex) in item.roles" :key="roleIndex"
                                    ...
                                    <div
                                        class="absolute -left-[5px] top-2 w-2 h-2 rounded-full bg-gray-300 dark:bg-gray-600">
                                    </div>
                                    <h3 class="text-lg font-bold text-gray-900 dark:text-white">{{ role.title }}</h3>
                                    <p class="text-sm text-primary font-medium mb-2">{{ role.period }}</p>
